...
for idx in [1]:
    ...
    Ind_pretrain = True
    Teacher_md_path = '/datahdd/xhjia/code/mmwhumanpose_training/data/posenet_0524_gru15_0.77.pth' #0411_gru.pth
    pre_md_pth = '/datahdd/xhjia/code/mmwhumanpose_training/data/posenet_0717_2000.pth'
    chkpnt_path = '/datahdd/xhjia/code/mmwhumanpose_training/checkpoint/ck_1718/checkpoint_11_epoch.pkl'
    lr = 0.0002
    bs = 80
    MAX_EPOCH = 2
    ...
    posenet = KPTSNet_S2(nkpoint=17, dimkpoint=3, ch=ch).to(DEVICE)
    ...
    # scheduler_mul = torch.optim.lr_scheduler.ExponentialLR(optimizer, 0.6、0.8)
