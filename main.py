...
for idx in [1]:
    ...
    Ind_pretrain = False
    pre_md_pth = '/datahdd/cxh/mmwhumanpose_training/checkpoint/ck_0809/posenet_0808_gru15F.pth'
    chkpnt_path = '/datahdd/xhjia/code/mmwhumanpose_training/checkpoint/ck_0309/checkpoint_49_epoch.pkl'
    lr = 0.002
    bs = 120
    MAX_EPOCH = 20
    ...
    file_path_ck = os.path.join("checkpoint", "3G_ck_" + dt)
    ...
    # train_root_paths = [
    #     "/datahdd/xhjia/data/new/traindata/20240929_3G/Rside_match",
    #     "/datahdd/xhjia/data/new/traindata/20240929_3G/Lside_match",
    ...
    #                       npoint=npoint)
    # with open('train_dataset_kpts_1007.pkl', 'wb') as file:
    #     pickle.dump(train_data, file)
    # with open('test_dataset_kpts_1007.pkl', 'wb') as file:
    #     pickle.dump(test_data, file)
    with open('/datahdd/xhjia/code/mmwhumanpose_training/train_dataset_kpts_1017.pkl', 'rb') as file:
        train_data = pickle.load(file)
    with open('/datahdd/xhjia/code/mmwhumanpose_training/test_dataset_kpts_1017.pkl', 'rb') as file:
    ...
    posenet = KPTSNet(nkpoint=17, dimkpoint=3, ch=ch).to(DEVICE)
        ...
        with torch.no_grad():
            ...
            if PCKm > 0.77:
                torch.save(posenet.state_dict(),
                           os.path.join(file_path_ck, "3G_checkpoint_PCKm_{}_epoch_{}.pth".format(round(PCKm, 4), epoch)))
                print("model saved")
        """
        Checkpoint save
        """
